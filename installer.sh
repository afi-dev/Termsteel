...
whiptail --msgbox --title "Invalid OS" "We have not been able to detect a supported OS.
Currently this installer supports Raspbian, Debian, Ubuntu." 15 50
    exit 1
}
...
# Force User to use good operating system
platform='unknown'
unamestr=$(uname)
